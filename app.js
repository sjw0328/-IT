  ...
  <div class="comment ${c.side}" data-cid="${c.id}">
    <div class="comment-top">
      <div class="comment-meta">
        ...
        <span class="nick ${c.side}"><span class="nk-dot"></span>${c.nickname}</span>
        ${best}${mine}
      </div>
...
async function openDetail(id, fromHistory) {
  ...
  if (_st) _st.innerHTML = `<button class="side-tab a is-on" data-sidetab="a">${icon('arrow-up', 15)}찬성 ${a}%</button><button class="side-tab b" data-sidetab="b">반대 ${b}%</button>`;
